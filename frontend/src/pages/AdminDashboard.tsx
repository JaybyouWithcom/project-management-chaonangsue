            ...
            <DialogContent className="sm:max-w-md">
              ...
              <div className="space-y-4 py-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div><Label>ราคาเช่า/วัน</Label><Input type="number" value={form.rentalPrice} onChange={(e) => setForm((p) => ({ ...p, rentalPrice: e.target.value }))} /></div>
                </div>
                <div><Label>มัดจำ</Label><Input type="number" value={form.depositPrice} onChange={(e) => setForm((p) => ({ ...p, depositPrice: e.target.value }))} /></div>
